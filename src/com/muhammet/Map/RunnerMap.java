...
public class RunnerMap {
	...
	public static void main(String[] args) {
		...
		bolumListesi.add(new Bolum(18, "Bilgi Ýþlem"));
		bolumListesi.add(new Bolum(42, "Ýnsan Kaynaklarý"));
		...
		// ÖNEMLÝ -> buraya mevcut bulnan departman bilgilerinden atam yapmalýsýnýz.
		// DÝKKAT!!! -> get ile aldýðým þey, bir listenini içindeki elemalarýn index deðeri ile 
		// alýnan bilgilerdir.
		personelList.add(new Personel(1, "Ahmet", "TAÞ", "0 555 111 1111",bolumListesi.get(0)));
		personelList.add(new Personel(2, "Canan", "TAÞ", "0 999 111 1111",bolumListesi.get(0)));
		personelList.add(new Personel(3, "Bahar", "TAÞ", "0 888 111 1111",bolumListesi.get(0)));
		personelList.add(new Personel(4, "Taner", "BULUÞ", "0 999 111 1111",bolumListesi.get(1)));
		...
		personelList.add(new Personel(7, "Temel", "TAÞ", "0 999 111 1111",bolumListesi.get(3)));
		personelList.add(new Personel(8, "Tahir", "TEK", "0 888 111 1111",bolumListesi.get(3)));
		personelList.add(new Personel(9, "Taha", "TAÞ", "0 555 111 1111",bolumListesi.get(3)));
		personelList.add(new Personel(10, "Tunç", "TEK", "0 999 111 1111",bolumListesi.get(3)));
		personelList.add(new Personel(11, "Güvenç", "BEKTAÞ", "0 888 111 1111",bolumListesi.get(2)));
		
		/***
		 * Key -> Departman
		 * Value -> Çalýþan Listesi
		 */
		...
		System.out.println("1- Bilgi Ýþlem");
		System.out.println("2- Ýnsan Kaynaklarý");
		...
		// bir K->V yapýsýnda anahtar verildiðinde deðeri döner
